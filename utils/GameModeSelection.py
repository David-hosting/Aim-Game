            ...
            if pygame.mouse.get_pressed()[0]:
                ...
                if self.pressed == True:
                    if self.check_btn_type() == 1:
                            pygame.display.set_caption('Aim Game - Normal')
                            game = Game.Screen(screen_size= (800, 600), fill= (97, 97, 97))
                            game.window #Yea that's a function lol
                    elif self.check_btn_type() == 0:
                        pygame.display.set_caption('Aim Game - Hard')
                        game = GameHard.Screen(screen_size= (800, 600), fill= (97, 97, 97))
                        game.window #Yea that's a function lol
                    else:
